module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'libs/angular-1.2.0-rc.2/angular-route.js',
      'libs/angular-1.2.0-rc.2/angular-mocks.js',
      'libs/ui-utils/ui-utils.js',
      'libs/ui-utils/ui-utils-ieshiv.js',
      'libs/ui-codemirror/ui-codemirror.js',
      'libs/ui-date/date.js',
      'libs/ui-bootstrap-0.6.0/ui-bootstrap-tpls-0.6.0.min.js',
      'js/*.js',
