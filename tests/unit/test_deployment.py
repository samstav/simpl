...
class TestDeployments(unittest.TestCase):
    ...
    def test_can_add_new_resources_for_add_node_with_hosts(self):
        deployment_dict = {
            'id': 'test',
            'name': 'test',
            'resources': {
                '0': {
                    ...
                    'index': '0',
                    'hosts': ['2'],
                    'dns-name': 'service01.something100.com'

                },
                '1': {'provider': 'test', "service": "some_thing_else"},
                '2': {
                    'status': 'ACTIVE',
                    'provider': 'chef-solo',
                    'service': 'lb',
        ...
        deployment.add_node("lb", 2)
        self.assertEquals(len(deployment["resources"]), 7)
        self.assertDictEqual(deployment["resources"]["3"], {
            'provider': 'compute',
            'service': 'lb',
            'index': '3',
            'status': 'PLANNED',
            'hosts': ['4'],
            'dns-name': 'service02.something100.com'
        })
        self.assertDictEqual(deployment["resources"]["4"], {
            'provider': 'chef-solo',
            'service': 'lb',
            'index': '4',
            'status': 'PLANNED',
            'hosted_on': "3",
            'relations': {'host': {'target': '3'}}
        })
        self.assertDictEqual(deployment["resources"]["5"], {
            'provider': 'compute',
            'service': 'lb',
            'index': '5',
            'status': 'PLANNED',
            'hosts': ['6'],
            'dns-name': 'service03.something100.com'
        })
        self.assertDictEqual(deployment["resources"]["6"], {
            'provider': 'chef-solo',
            'service': 'lb',
            'index': '6',
            'status': 'PLANNED',
            'hosted_on': "5",
            'relations': {'host': {'target': '5'}}
        })

    def test_can_add_new_resources_for_add_node(self):
        deployment_dict = {
            'id': 'test',
            'name': 'test',
            'resources': {
